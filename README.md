...
Вся ответственность за запуск, настройку (включая смену стандартных паролей и ключей в `.env`) и использование проекта лежит исключительно на конечном пользователе.
